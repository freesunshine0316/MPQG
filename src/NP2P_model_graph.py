...
class ModelGraph(object):
    def __init__(self, word_vocab=None, char_vocab=None, POS_vocab=None, NER_vocab=None, options=None, mode='ce_train'):
        ...
        with variable_scope.variable_scope("generator"):
            ...
            if mode == 'decode':
                ...
                self.accu, self.loss, _ = self.generator.train_mode(word_vocab, self.encode_dim, self.phrase_representations, self.encoder_features,
                    self.phrase_idx, self.phrase_mask, self.init_decoder_state,
